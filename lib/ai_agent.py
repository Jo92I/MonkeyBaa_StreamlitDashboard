...
def analyse_ssot():
    ...
    if not ssot["okr_frameworks"] or not ssot["survey_data"]:
    ...
    results["Status"] = results["Gap"].apply(lambda x: "Below Target" if x > 0 else "On/Above Target")
